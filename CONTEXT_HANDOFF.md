...
生成：2026-09-11 10:19 (UTC+8)

## 本会话已做
- 范围异常走近改当前帧 boss+mon 均值；缺检才退 `_dist_center`

## 下一对话先做
- **边打边调** F10 回城钮（默认 tn_s=30s）；提取规则已变 → 先「重新提取本图」/重提 `skill_features`
- 手感 + 叠图；不要另开架构盖 txt
- 组集 fill/相对仍未确认
...
- YOLO：`D:/Desktop/T/test/images/Atrain/runs/mix_a/weights/best.pt`
